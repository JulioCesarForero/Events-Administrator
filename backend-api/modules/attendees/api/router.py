...
from infrastructure.persistence.models import AttendeeGroup, Event, Participant, StaffUser
...
def list_participants(
    ...
    _can_access_group(db, staff, None, group_id)
    return list(
        db.execute(
...
def create_participant(
    ...
    try:
        ensure_participant_editable_window(ev.event_date)
